...
var fecha=document.getElementsByName("fechaNacimiento")[0].value;       
    ...
    {
        document.getElementById('mensajeFecha').innerHTML = '<br>Ingrese bien laFecha Incorrecta formato dd/mm/YYY'
        elemento.style.border = '1px red solid'
        elemento.className = 'error'
    ...
    document.getElementById('fechaNacimiento').value = ' '
        ...
        document.getElementById('mensajeFecha').innerHTML = '<br>'
        elemento.style.border = '1px black solid'
        elemento.className='bien'  
    }
